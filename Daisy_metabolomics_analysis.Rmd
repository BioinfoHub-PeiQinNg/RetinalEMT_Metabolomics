...
df <-as.data.frame(pca_res$x) %>% rownames_to_column("Sample") %>% mutate(Treatments = cells_comb_data$Treatment) %>% select(Sample,Treatments, PC1:PC24)
...
DF_stats_cb  <- DF_stats_cb %>%  as.tibble() %>% mutate(dplabel = replace(dplabel, !dplabel %in% DP_names_cb, NA) )
...
#listout samples which are for cells (control vs TNFa)
Cells_Control <- c("X1_001","X2_002","X3_003", "X4_004", "X5_005","X6_006", "X7_007", "X8_008")
Cells_TGFb <-c("X9_009", "X10_010","X11_011", "X12_012", "X13_013","X14_014", "X15_015", "X16_016")
...
DF_sub_cb <- inner_join(DF_sub_cb, meta_sub, by = "Sample") %>% 
    select(Metabolite, Sample, Treatment, Counts) %>% 
    mutate(Sample = factor(Sample, levels = c("X1_001","X2_002","X3_003", "X4_004", "X5_005","X6_006", "X7_007", "X8_008","X9_009", "X10_010","X11_011", "X12_012", "X13_013","X14_014", "X15_015", "X16_016"))) %>% 
...
DF_sub_ca_2 <- inner_join(DF_sub_2, meta_sub, by = "Sample") %>% 
    select(Metabolite, Sample, Treatment, Counts) %>% 
    mutate(Sample = factor(Sample, levels = c("X1_001","X2_002","X3_003", "X4_004", "X5_005","X6_006", "X7_007", "X8_008", "X17_017", "X18_018","X19_019","X20_020","X21_021", "X22_022","X23_023","X24_024","X9_009", "X10_010","X11_011", "X12_012", "X13_013","X14_014", "X15_015", "X16_016"))) %>% 
