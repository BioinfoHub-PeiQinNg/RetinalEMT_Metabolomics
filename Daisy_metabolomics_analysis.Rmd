...
Volcano plots (For Cells TNFa and Control)
...
Cells_control <- c("X1_001","X2_002", "X8_008","X34_034","X44_044","X45_045","X46_046","X47_047")
...
DF_sub_ca <- inner_join(DF_sub, meta_sub, by = "Sample") %>% 
    select(Metabolite, Sample, Treatment, Counts) %>% mutate(Sample = factor(Sample, levels = c("X1_001","X2_002", "X8_008","X34_034","X44_044","X45_045","X46_046","X47_047", "X17_017", "X18_018","X19_019","X20_020","X21_021", "X22_022","X23_023","X24_024")))
